<?php
/**
 * CLI entry for the About Us → Page Components migrator.
 *
 * Usage (Local PHP on Windows):
 *   php -c %APPDATA%\Local\run\<siteId>\conf\php\php.ini about-us-to-page-components-cli.php [--force]
 *
...
require_once dirname(__FILE__) . '/about-us-to-page-components.php';
