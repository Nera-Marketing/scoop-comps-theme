<?php
/**
 * CLI entry for the Contact → Page Components migrator.
 *
 * Usage (Local PHP on Windows):
 *   php -c %APPDATA%\Local\run\<siteId>\conf\php\php.ini contact-to-page-components-cli.php [--force]
 *
...
require_once dirname(__FILE__) . '/contact-to-page-components.php';
