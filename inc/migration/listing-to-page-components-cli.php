<?php
/**
 * CLI entry for the competition listing → Page Components migrator.
 *
 * Usage (Local PHP on Windows):
 *   php -c %APPDATA%\Local\run\<siteId>\conf\php\php.ini listing-to-page-components-cli.php [--force]
 *
...
require_once dirname(__FILE__) . '/listing-to-page-components.php';
