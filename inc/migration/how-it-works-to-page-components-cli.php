<?php
/**
 * CLI entry for the How It Works → Page Components migrator.
 *
 * Usage (Local PHP on Windows):
 *   php -c %APPDATA%\Local\run\<siteId>\conf\php\php.ini how-it-works-to-page-components-cli.php [--force]
 *
...
require_once dirname(__FILE__) . '/how-it-works-to-page-components.php';
