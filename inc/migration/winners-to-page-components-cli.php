<?php
/**
 * CLI entry for the Winners → Page Components migrator.
 *
 * Usage (Local PHP on Windows):
 *   php -c %APPDATA%\Local\run\<siteId>\conf\php\php.ini winners-to-page-components-cli.php [--force]
 *
...
require_once dirname(__FILE__) . '/winners-to-page-components.php';
