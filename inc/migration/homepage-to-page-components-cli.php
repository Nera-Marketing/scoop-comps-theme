<?php
/**
 * CLI entry for the homepage → Page Components migrator.
 *
 * Usage (Local PHP on Windows):
 *   php -c %APPDATA%\Local\run\<siteId>\conf\php\php.ini homepage-to-page-components-cli.php [--force]
 *
 * Bootstraps wp-load.php. Resolves MySQL port from %APPDATA%/Local/sites.json
 * and defines DB_HOST before wp-config runs.
 *
...
// Local site path in sites.json is the site root (parent of app/), e.g. D:/sites/scoop-comps
...
require_once dirname(__FILE__) . '/homepage-to-page-components.php';
